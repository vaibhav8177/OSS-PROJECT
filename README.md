...
bashbash scripts/script1_system_identity.sh
Prints distro, kernel version, logged-in user, uptime, date/time, and the OS license.
Script 2 — Package Inspector
bashbash scripts/script2_package_inspector.sh
...
bashbash scripts/script3_disk_auditor.sh
...
bashbash scripts/script5_manifesto_generator.sh
